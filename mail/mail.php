...
$sendingAccountUsername     = 'recrentals@gmail.com';
$sendingAccountPassword     = 'DHKRgjp3';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'tyler@rec-rents.com'; // REQUIRED value.
$recipientName              = 'Tyler Hanson';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'Message from your website.'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'Rec-rents.com';                // REQUIRED value. This is used when a name or email is not collected from the website form
